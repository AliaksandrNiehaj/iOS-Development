...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HomeWork_4_Instalog",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19HomeWork_4_Instalog11AppDelegate")
...
SWIFT_CLASS("_TtC19HomeWork_4_Instalog13SceneDelegate")
...
SWIFT_CLASS("_TtC19HomeWork_4_Instalog19StartViewController")
@interface StartViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified continueAsButton;
...
- (void)viewDidLoad;
- (IBAction)continueAsButtonDidTap:(UIButton * _Nonnull)sender;
- (IBAction)signUpButtonDidTap:(UIButton * _Nonnull)sender;
- (IBAction)signInButtonDidTap:(UIButton * _Nonnull)sender;
